...
<body>
    ...
    <input type="number" id="tbNominaPengirim" name="nominal" class="form-control">
    <label>Metode Pembayaran</label>
    <div class="from-check">
        <input type="radio" name="metode" id="tbTransfer" class="from-check-input" value="Transfer">
        <label for="tbTransfer" class="form-label">Transfer</label>
    </div>
    <div class="from-check">
    <input type="radio" name="metode" id="tbQris" class="from-check-input" value="Qris">
        <label for="tbQris" class="form-label">Qris</label>
    </div>
    <div class="from-check">
        <input type="radio" name="metode" id="tbShopeepay" class="from-check-input" value="Shopeepay">
        <label for="tbShopeepay" class="form-label">Shopeepay</label>
    </div>
    <div class="from-check">
        <input type="radio" name="metode" id="tbGopay" class="from-check-input" value="Gopay">
